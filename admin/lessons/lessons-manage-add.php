...
<body>
     ...
     <section class="Courses-filter  Pt-3 pb-3 background-one">
      <div class="container">
       <div class=" text-start pb-3">
        <h1 class="fs-1 fw-bolder home-h1  pt-3">Add Lesson </h1>
       </div>
              ...
              <div class="card-body col-md-12">
               <div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
                ...
                <div class="card-body small">
                 ...
                 <form action="lesson-add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                  <div class="form-group">
                   <label for="email">Lesson Name :</label>
                   <input type="text" class="form-control" id="l_name" placeholder="Enter Lesson Name"
                    name="lesson_name">
                   <span id="name_error" class="text-danger font-weight-bold"></span>
                  </div>
                  <div class="form-group">
                   <label for="pwd">Lesson
                    Description</label>
                   <input type="text" class="form-control" id="l_desc" placeholder="Enter Lesson Description"
                    name="lesson_desc">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>

                  <div class="form-group">
                   <label for="pwd">Lesson Image</label>
                   <input type="file" class="form-control" id="l_img" placeholder="Enter Lesson Image"
                    name="lesson_image">
                  ...
                  <div class="form-group">
                   ...
                   <input type="number" class="form-control" id="" placeholder="Enter Course Id"
                    name="course_id">
 ...
 <script type="text/javascript">
  ...
  function validation() {
   ...
   var desc = document.getElementById('l_desc').value;
   var img = document.getElementById('l_img').value;
   if (name == "") {
