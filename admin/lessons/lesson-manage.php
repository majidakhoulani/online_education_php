     ...
     <section class="Courses-filter  Pt-3 pb-3 background-one">
      <div class="container">
       <div class=" text-start pb-3">
        <h1 class="fs-1 fw-bolder home-h1  pt-3">Manage Lesson</h1>
       </div>
                ...
                <div class="card-body small">
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                   ...
                   <label for="exampleFormControlSelect1">Lesson
                    Name</label>
                   <input type="text" name="lesson_title" value="<?php echo htmlentities($lesson_title); ?>">
                  ...
                  <div class="form-group">
                   <label for="pwd">Lesson
                    Description</label>
                   <input type="text" name="lesson_description" value="<?php echo htmlentities($lesson_desc); ?>">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>
                  ...
                  <div class="form-group">
                   <label for="pwd">Lesson
                    Image</label>
                   <img src="<?php echo htmlentities($lesson_image); ?>" height="200px" width="200px" />
                ...
                <div class="card-body small">
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                   ...
                   <label for="exampleFormControlSelect1">Lesson
                    id</label>
                   <input type="number" name="lesson_id" value="<?php echo htmlentities($lesson_id); ?>">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>
