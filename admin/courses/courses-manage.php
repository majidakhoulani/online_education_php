     ...
     <section class="Courses-filter  Pt-3 pb-3 background-one">
      <div class="container">
       <div class=" text-start pb-3">
        <h1 class="fs-1 fw-bolder home-h1  pt-3">Manage Course</h1>
       </div>
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                   ...
                   <label for="exampleFormControlSelect1">Course
                    Name</label>
                   <input type="text" name="course_title" value="<?php echo htmlentities($course_title); ?>">
                  ...
                  <div class="form-group">
                   <label for="pwd">Course
                    Description</label>
                   <input type="text" name="course_description" value="<?php echo htmlentities($course_desc); ?>">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>
                  ...
                  <div class="form-group">
                   <label for="pwd">Course
                    Image</label>
                   <img src="<?php echo htmlentities($course_image); ?>" height="200px" width="200px" />
                ...
                <div class="card-body small">
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                   ...
                   <label for="exampleFormControlSelect1">Course
                    id</label>
                   <input type="number" name="course_id" value="<?php echo htmlentities($course_id); ?>">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>
