...
<body>
     ...
     <section class="Courses-filter  Pt-3 pb-3 background-one">
      <div class="container">
       <div class=" text-start pb-3">
        <h1 class="fs-1 fw-bolder home-h1  pt-3">Add Category</h1>
       </div>
          ...
          <div class="col-md-8 ">
           <div class="card mt-3 tab-card">
            <div class="card-header tab-card-header">
             <h5 class="fs-4 text-danger">ADD Category</h5>
              ...
              <div class="card-body col-md-12">
               <div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
                ...
                <div class="card-body small">
                 ...
                 <form action="categories-add.php" method="post" enctype="multipart/form-data"
                  ...
                  <div class="form-group">
                   <label for="pwd">Category
                    Description</label>
                   <input type="text" class="form-control" id="cat_desc"
                    placeholder="Enter Category Description" name="category_desc">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>

                  <div class="form-group">
                   <label for="pwd">Category Image</label>
                   <input type="file" class="form-control" id="cat_img" placeholder="Enter Category Image"
                    name="category_image">
 ...
 <script type="text/javascript">
  ...
  function validation() {
   ...
   var img = document.getElementById('cat_img').value;
   if (name == "") {
