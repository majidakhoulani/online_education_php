     ...
     <section class="Courses-filter  Pt-3 pb-3 background-one">
      <div class="container">
       <div class=" text-start pb-3">
        <h1 class="fs-1 fw-bolder home-h1  pt-3">Manage Category </h1>
       </div>
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                   ...
                   <label for="exampleFormControlSelect1">Category
                    Name</label>
                   <input type="text" name="category_title" id="cat_name" value="<?php echo htmlentities($category_title); ?>">
                  ...
                  <div class="form-group">
                   <label for="pwd">Category
                    Description</label>
                   <input type="text" name="category_description" id="cat_desc" value="<?php echo htmlentities($category_desc); ?>">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>
                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                   ...
                   <label for="exampleFormControlSelect1">Course
                    id</label>
                   <input type="number" name="category_id" value="<?php echo htmlentities($category_id); ?>">
                   <span id="desc_error" class="text-danger font-weight-bold"></span>
                  </div>
