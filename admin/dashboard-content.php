...
$sql1 = 'SELECT COUNT(*) as `count1` FROM courses';
$result1 = $conn->query($sql1);
$sql2 = 'SELECT COUNT(*) as  `count2` FROM lessons';
...
<div class="row">
  ...
  <div class="card mb-3 widget-content bg-midnight-bloom">
   <div class="widget-content-wrapper text-white">
    ...
    <div class="widget-content-right">
     <div class="widget-numbers text-white"><span><?php echo htmlentities($count); ?></span></div>
    </div>
    <?php } }?>
  ...
  <div class="card mb-3 widget-content bg-arielle-smile">
   <div class="widget-content-wrapper text-white">
    ...
    <?php
              ...
              ?>
    <div class="widget-content-right">
     <div class="widget-numbers text-white"><span><?php echo htmlentities($count1); ?></span></div>
    </div>
    <?php } }?>
   </div>
  </div>
 ...
 <div class="col-md-6 col-xl-4">
  <div class="card mb-3 widget-content bg-grow-early">
   <div class="widget-content-wrapper text-white">
    <div class="widget-content-left">
     <div class="widget-heading">Total Lessons</div>
    ...
    <?php
              ...
              ?>
    <div class="widget-content-right">
     <div class="widget-numbers text-white"><span><?php echo htmlentities($count2); ?></span></div>
    </div>
    <?php } }?>
   </div>
  </div>
 ...
 <!-- <div class="d-xl-none d-lg-block col-md-6 col-xl-4">
                            <div class="card mb-3 widget-content bg-premium-dark">
                                <div class="widget-content-wrapper text-white">
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Courses Students</div>
                                        <div class="widget-subheading">Revenue streams</div>
                                    </div>
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-warning"><span>48%</span></div>
                                    </div>
                                </div>
                            </div>
                        </div> -->
 ...
 <div class="col-md-6 col-xl-4">
  <div class="card mb-3 widget-content">
   <div class="widget-content-outer">
    <div class="widget-content-wrapper">
     <div class="widget-content-left">
      <div class="widget-heading">Courses Sold</div>
      <div class="widget-subheading">Revenue streams</div>
     </div>
     <div class="widget-content-right">
...
?>
      <tr>
       <td class="text-center text-muted"><?php echo htmlentities($row3['user_id']); ?></td>
       <td>
        <div class="widget-content p-0">
         <div class="widget-content-wrapper">
          <!-- <div class="widget-content-left mr-3">
          ...
          <div class="widget-content-left">
           <div class="widget-heading"><?php echo htmlentities($row3['user_name']); ?></div>
   ...
   <td class="text-center"><?php echo htmlentities($row3['user_email']); ?></td>
   <td class="text-center">
    <div class="badge badge-warning"><?php echo htmlentities($row3['user_password']); ?></div>
   </td>
   </tr>
   <?php
$i++;
...
?>
       <tr>
        <td class="text-center text-muted"><?php echo htmlentities($row4['cat_id']); ?></td>
        <td>
         <div class="widget-content p-0">
          <div class="widget-content-wrapper">
           <!-- <div class="widget-content-left mr-3">
           ...
           <div class="widget-content-left">
            <div class="widget-heading"><?php echo htmlentities($row4['cat_title']); ?></div>
            <!-- <div class="widget-subheading opacity-7">Web Developer -->
           </div>
          </div>
         </div>
...
?>
      <tr>
       <td class="text-center text-muted"><?php echo htmlentities($row5['course_id']); ?></td>
       <td>
        <div class="widget-content p-0">
         <div class="widget-content-wrapper">
          <!-- <div class="widget-content-left mr-3">
          ...
          <div class="widget-content-left">
           <div class="widget-heading"><?php echo htmlentities($row5['course_name']); ?></div>
           <!-- <div class="widget-subheading opacity-7">Web Developer -->
          </div>
         </div>
        </div>
   ...
   <td class="text-center text-muted"><?php echo htmlentities($row5['cat_id']); ?></td>
   </tr>
   <?php
$i++;
}
